...
extern unsigned char ps2hdd_hdl_irx[];
extern unsigned int size_ps2hdd_hdl_irx;
...
static const char ps2hdd_args[] = "-o"
                                  "\0"
                                  "4"
                                  "\0"
                                  "-n"
...
void boot_iop_with_modules(void) {
  ...
  fails += load_irx("bdmfs_fatfs", bdmfs_fatfs_irx, size_bdmfs_fatfs_irx, 0,
                    NULL) < 0;
  fails +=
      load_irx("usbmass_bd", usbmass_bd_irx, size_usbmass_bd_irx, 0, NULL) < 0;
